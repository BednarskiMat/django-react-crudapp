		...
		return (
			<div className="card" /* style="width: 18rem;" */>
				<div className="card-header d-flex justify-content-between">
					...
					<div>
						<span onClick={this.props.onEditClick} className="mr-2"><i className="fa fa-pencil"></i></span>
						<span onClick={this.props.onDeleteClick}><i className="fa fa-trash-o"></i></span>
					</div>
